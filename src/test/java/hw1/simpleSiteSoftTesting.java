...
public class simpleSiteSoftTesting {
    ...
    public void simpleTest(){
        ...
        softAssert.assertEquals(headerItem.get(0).getText(), "HOME");
        softAssert.assertEquals(headerItem.get(1).getText(), "CONTACT FORM");
        softAssert.assertEquals(headerItem.get(2).getText(), "SERVICE");
        softAssert.assertEquals(headerItem.get(3).getText(), "METALS & COLORS");
